...
6. Record worker handoff status and barrier outputs.
7. Let a single integration owner write shared run artifacts.
8. Use read-only triage before repair when simulation fails.
9. Let parent/gate decide closure.
