...
REQUIRED_FILES = (
    ...
    CODEX_ROOT / "oag" / "feature-ipxact-policy.md",
    CODEX_ROOT / "oag" / "decision-matrix-policy.md",
    CODEX_ROOT / "oag" / "decision-autonomy-policy.md",
    CODEX_ROOT / "oag" / "mission-charter-policy.md",
    CODEX_ROOT / "oag" / "architecture-option-policy.md",
    CODEX_ROOT / "oag" / "architecture-bench-policy.md",
    CODEX_ROOT / "oag" / "dse-worktree-policy.md",
    CODEX_ROOT / "oag" / "exploration-cleanup-policy.md",
    ...
    CODEX_ROOT / "oag" / "team-mode-policy.md",
    ...
    CODEX_ROOT / "oag" / "windows-portability-policy.md",
    ...
    CODEX_ROOT / "rules" / "oag-decision-autonomy.rules.md",
    ...
    CODEX_ROOT / "skills" / "oag-lock-preview-frame" / "SKILL.md",
    ...
    CODEX_ROOT / "skills" / "oag-team-mode" / "SKILL.md",
    ...
    SCRIPTS_DIR / "oag_closure_super_gate.py",
    SCRIPTS_DIR / "oag_cli.py",
    SCRIPTS_DIR / "oag_dispatch.py",
    SCRIPTS_DIR / "oag_thread_worker.py",
    SCRIPTS_DIR / "oag_thread_worker_test.py",
    SCRIPTS_DIR / "oag_domain_crossing_check.py",
    SCRIPTS_DIR / "oag_exec_auto_research.py",
    SCRIPTS_DIR / "oag_implementation_review_check.py",
    ...
    SCRIPTS_DIR / "oag_semantic_projection_check.py",
    SCRIPTS_DIR / "oag_selective_hardening_test.py",
    SCRIPTS_DIR / "oag_authoring_packet_check.py",
    SCRIPTS_DIR / "oag_lifecycle_check.py",
    SCRIPTS_DIR / "oag_loop_core.py",
    SCRIPTS_DIR / "oag_loop_hook.py",
    SCRIPTS_DIR / "oag_loop_runner.py",
    SCRIPTS_DIR / "oag_baseline_check.py",
    SCRIPTS_DIR / "oag_baseline_cut.py",
    SCRIPTS_DIR / "oag_baseline_verify.py",
    SCRIPTS_DIR / "oag_ip_git.py",
    SCRIPTS_DIR / "oag_ip_version_check.py",
    SCRIPTS_DIR / "oag_gate_frame.py",
    SCRIPTS_DIR / "oag_lock_preview_frame.py",
    SCRIPTS_DIR / "oag_orchestration_guard.py",
    SCRIPTS_DIR / "oag_review_frame.py",
    SCRIPTS_DIR / "oag_run_control_common.py",
    SCRIPTS_DIR / "oag_run_frame.py",
    SCRIPTS_DIR / "oag_action_model_check.py",
    SCRIPTS_DIR / "oag_mission_runtime.py",
    SCRIPTS_DIR / "oag_mission_loop.py",
    SCRIPTS_DIR / "oag_exploration_plan.py",
    SCRIPTS_DIR / "oag_decision_autoresolve.py",
    SCRIPTS_DIR / "oag_mission_charter.py",
    SCRIPTS_DIR / "oag_architecture_options.py",
    SCRIPTS_DIR / "oag_arch_bench.py",
    SCRIPTS_DIR / "oag_parameter_sweep.py",
    SCRIPTS_DIR / "oag_dse_worktree.py",
    SCRIPTS_DIR / "oag_pending_questions.py",
    SCRIPTS_DIR / "oag_exploration_cleanup_check.py",
    SCRIPTS_DIR / "oag_action_plan.py",
    SCRIPTS_DIR / "oag_action_wavefront_draft.py",
    SCRIPTS_DIR / "oag_team_plan.py",
    SCRIPTS_DIR / "oag_action_record.py",
    SCRIPTS_DIR / "oag_operation_review_frame.py",
    SCRIPTS_DIR / "oag_role_health.py",
    SCRIPTS_DIR / "oag_windows_smoke.py",
    SCRIPTS_DIR / "oag_ssot_section_check.py",
    ...
    SCHEMAS_DIR / "oag_thread_execution.schema.json",
    ...
    SCHEMAS_DIR / "oag_semantic_projection.schema.json",
    ...
    SCHEMAS_DIR / "oag_operation_action_types.schema.json",
    SCHEMAS_DIR / "oag_mission_templates.schema.json",
    SCHEMAS_DIR / "oag_mission_instance.schema.json",
    SCHEMAS_DIR / "oag_action_candidates.schema.json",
    SCHEMAS_DIR / "oag_action_graph.schema.json",
    SCHEMAS_DIR / "oag_exploration_plan.schema.json",
    SCHEMAS_DIR / "oag_mission_charter.schema.json",
    SCHEMAS_DIR / "oag_architecture_candidates.schema.json",
    SCHEMAS_DIR / "oag_architecture_scoreboard.schema.json",
    SCHEMAS_DIR / "oag_arch_bench_result.schema.json",
    SCHEMAS_DIR / "oag_parameter_sweep.schema.json",
    SCHEMAS_DIR / "oag_pending_questions.schema.json",
    SCHEMAS_DIR / "oag_action_wavefront_draft.schema.json",
    SCHEMAS_DIR / "oag_team_plan.schema.json",
    SCHEMAS_DIR / "oag_action_instance.schema.json",
    CODEX_ROOT / "oag" / "operation_action_types.yaml",
    CODEX_ROOT / "oag" / "mission_templates.yaml",
)
...
REQUIRED_DOC_SNIPPETS = {
    CODEX_ROOT / "AGENTS.md": (
        ...
        "feature-ipxact-policy.md",
        "decision-matrix-policy.md",
        "decision-autonomy-policy.md",
        "mission-charter-policy.md",
        "architecture-option-policy.md",
        "architecture-bench-policy.md",
        "dse-worktree-policy.md",
        "exploration-cleanup-policy.md",
        "oag_architecture_options.py",
        "generate|estimate|score|promote",
        "knowledge/views/promoted/arch",
        "oag_arch_bench.py",
        "oag_dse_worktree.py",
        "oag_exploration_cleanup_check.py",
        ...
        "IP-local git",
        "wavefront-policy.md",
        "rtl_module_fanout.yaml",
        "tb_common_then_scenario_fanout.yaml",
        "role-structured RTL/TB",
        "RTL_INTERFACE_SHELL",
        "TB_DRIVER_BFM",
        "TB_PREDICTOR_MODEL",
        "oag_wavefront.py",
        ...
        "No lock, no RTL",
        "lock preview",
        "oag_lock_preview_frame.py",
        "verbatim source panels",
...
def check_config_policy(issues: list[dict[str, str]]) -> None:
    ...
    if not isinstance(multi_agent_v2, dict) or int(multi_agent_v2.get("max_concurrent_threads_per_session") or 0) < 1000:
        issues.append(issue("MULTI_AGENT_V2_LIMIT", ".codex/config.toml should set [features.multi_agent_v2].max_concurrent_threads_per_session = 1000.", path))
