...
from oag_dispatch_support import dispatch_integrity, dispatch_integrity_fields  # noqa: E402
...
def main() -> int:
    ...
    assert dispatch_integrity_fields(current)[-2:] == ["execution_budget", "context_contract"]
    ...
    print('{"status":"pass","tests":14,"suite":"oag_execution_efficiency"}')
    return 0
